...
constexpr const char* const FIRSTNAME = "Michal";
constexpr const char* const SURNAME   = "Czosnyka";
constexpr const char* const MAIL    = "mczosnyka@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "416031";
