...
// TODO: ...
protected:
    inline static size_t instances_ = 0;
    char* data_;
    size_t size_;
    size_t capacity_;
public:
    ...
    SimpleString(const char* text);
    SimpleString(const SimpleString& text);
    SimpleString(SimpleString&& string1);
    ~SimpleString();
    size_t size() const;
    ...
    bool equal_to(SimpleString new_string, bool case_sensitive=true) const;
    void append(SimpleString new_string);
    SimpleString substr(size_t pos = 0, size_t count = -1) const;
    int compare(SimpleString newstring, bool case_sensitive=true) const;
